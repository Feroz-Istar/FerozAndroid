package sample.androido.com.myapplication.customui.customviewpager;
...
public class CaurosalViewPager  extends ViewPager implements ViewPager.PageTransformer {
    ...
    public CaurosalViewPager(Context context, AttributeSet attrs) {
        ...
        setPadding(mPageMargin, mPageMargin, (int)mPageMargin, mPageMargin);
    }
    ...
    public void setCustomPageMargin(int left,int top,int right,int bottom) {
